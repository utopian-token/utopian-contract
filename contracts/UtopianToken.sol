...
/**
   ...
   #UtopianToken features:
   10% fee auto add to the liquidity pool to locked forever when selling
   10% fee auto distribute to all holders
   I created a black hole so #UtopianToken token will deflate itself in supply with every transaction
...
contract UtopianToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 ** 3 * 10 ** 9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Utopian Token";
    string private _symbol = "UTP";
